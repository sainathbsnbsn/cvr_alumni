...
$sql = "INSERT INTO needs(name,email,branch,need)  VALUES('$name','$email','$branch','$need')";
...
$select='SELECT * FROM needs ORDER BY `id` DESC';
$need_result=mysqli_query($db,$select);
    ...
    <!-- /main nav -->
		...
		<div class="row ">
			...
			<div class="title text-center wow fadeIn" data-wow-duration="500ms">
				<h2>Need<span class="color">s</span></h2>
...
<?php if(isset($_SESSION['access_token']))
   { ?>
			...
			<div class="contact-form col-md-6 wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
					...
					<div class="form-group">
						<textarea rows="6" placeholder="Need" class="form-control" name="need" id="message"></textarea>	
					</div>

					
					
					<div id="cf-submit">
					<input type="submit" name="need_submit" id="need_submit" class="btn btn-transparent" value="Submit" style="background-color: #57cbcc;">
					</div>						
		...
		<?php } ?>
			<!-- ./End Contact Form -->
				<!-- Contact Form -->
			<div class="col-6 contact-form col-md-<?php if(isset($_SESSION['access_token'])){ echo '6';}else{echo'8';} 
    ?> wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms" >
				
					<?php while($row=mysqli_fetch_array($need_result)){ ?>
					<div class="form-group" style="border:none;border-left: #57cbcc solid 5px;padding-left: 10px;">
						
						<h4><?php echo$row['name']; ?></h4>
						<p><?php echo$row['email'].' - '.$row['branch']; ?></p>
